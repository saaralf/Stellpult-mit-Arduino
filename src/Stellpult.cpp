...
bool WEICHE1 = false;  // False gerade, true abzweig
bool WEICHE2 = false;  // False gerade, true abzweig
bool WEICHE3 = false;  // False gerade, true abzweig
bool WEICHE4 = false;  // False gerade, true abzweig
bool WEICHE5 = false;  // False gerade, true abzweig
bool WEICHE6 = false;  // False gerade, true abzweig
bool WEICHE7 = false;  // False gerade, true abzweig
bool WEICHE8 = false;  // False gerade, true abzweig
bool WEICHE9 = false;  // False gerade, true abzweig
bool WEICHE10 = false; // False gerade, true abzweig
bool WEICHE11 = false; // False gerade, true abzweig
bool WEICHE12 = false; // False gerade, true abzweig
bool WEICHE13 = false; // False gerade, true abzweig
bool WEICHE14 = false; // False gerade, true abzweig
//Construktor
Stellpult::Stellpult()
{
