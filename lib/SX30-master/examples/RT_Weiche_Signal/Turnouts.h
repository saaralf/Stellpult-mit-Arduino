...
#define N_TURNOUTS     4   // maximum 4 turnouts
...
public:
    Turnouts(uint8_t);  // a single turnout
    Turnouts(uint8_t, uint8_t);  // 2 turnouts
	  Turnouts(uint8_t, uint8_t, uint8_t);  // 3 turnouts
...
private:
    ...
    uint8_t _npins;  // actual number of turnouts
